			...
			'<table class="ext-cal-bg-tbl" cellpadding="0" cellspacing="0">',
                '<tbody>',
                    ...
                    '<tr class="ext-cal-bg-tbl-bd">',
                        '<tpl for="calendars">',
                            '<tpl if="data.IsHidden &#61;&#61; 0">',
                                '<td id="{[this.id]}-calendar-{[xindex-1]}" class="{[this.cellCls]}">',
                                 '&#160;',
                                '</td>',
                            '<tpl else>',
                                '<td style="display:none;"></td>',
                ...
                '<tbody>',
                    ...
                    '<tr>',
                        ...
                        '<tpl for="calendars">',
                            ...
                            '<tpl for=".">',
                                '<tpl if="data.IsHidden &#61;&#61; 0">',
                                 '<td id="{[this.id]}-calendar-{[values.cindex-1]}-wk-0-empty-day-{[Ext.Date.format(this.viewStart,\'Ymd\')]}" class="ext-cal-hd-daytext {[this.titleCls]}">',
                                    '<div id="{[this.id]}-calendar-{[values.cindex-1]}">',
                    ...
                    '<tpl for="calendars">',
                        '<tpl if="data.IsHidden &#61;&#61; 0">',
                            '<tpl exec="values.cindex = xindex;"></tpl>',
                            '<td id="{[this.id]}-calendar-{[xindex-1]}-wk-0">',
                                '<table class="ext-cal-evt-tbl ext-cal-hd-day ext-cal-dayview" cellpadding="0" cellspacing="0">',
                                    '<tpl for=".">',
                                        '<tr style="display:none;">',
                                            '<td class="ext-cal-ev" id="{[this.id]}-calendar-{[values.cindex-1]}-empty-0-day-{[Ext.Date.format(this.viewStart,\'Ymd\')]}">&nbsp;</td>',
                                        '</tr>',
                                     '</tpl>',
                                '</table>',
                            '</td>',
